...
export default function EstadoAtencionSalud() {
                ...
                >
                    ...
                    <Paper>
                        <Box component='form'
                            sx={{ width: '100%' }}
                        >
                            <Typography variant='h6'>Mi atención
                            </Typography>
                            <Grid
                                container
                        ...
                        {
                            edoAtencionSalud !== null ? ( //if we got elements then we render them. if not then we don't render nothing.
